...
public:
  ...
  double PID_TriacDelay = 0;              ///< Delay after a zero crossing, before turning on the TRIAC. Calculated from PID_Output
  uint8_t *TriacActiveTicks = NULL;   ///< Keep the HIGH signal on the TRIAC gate (default: 20 timer ticks -> 10μs)
...
protected:
  ...
  bool *PIDEnabled = NULL; ///< Enable/disable motor speed stabilization under variable load based on RPM feedback
