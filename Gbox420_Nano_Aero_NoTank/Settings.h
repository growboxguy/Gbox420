...
typedef struct
{
  ...
  struct AeroponicsModuleSettings Aero1 = {.SerialReportFrequency = 15, .SerialReportDate = false, .SerialReportMemory = false, .SerialReportText = false, .SerialReportJSON = false, .SerialReportWireless=true};
