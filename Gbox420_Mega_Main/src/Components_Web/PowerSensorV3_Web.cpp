...
PowerSensorV3_Web::PowerSensorV3_Web(const __FlashStringHelper *Name, Module_Web *Parent, HardwareSerial *SerialPort) : Common(Name), Common_Web(Name), PowerSensorV3(Name, Parent, SerialPort), Parent(Parent)
{
