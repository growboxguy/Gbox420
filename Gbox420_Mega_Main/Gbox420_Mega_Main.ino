...
HardwareSerial &ArduinoSerial = Serial1;     ///< Reference to the Arduino Serial output : Mega 2560 Rev3	Serial:0(RX) 1(TX), Serial1:19(RX1) 18(TX1), Serial2:17(RX2), 16(TX2), Serial4:15(RX3) 14(TX3)
