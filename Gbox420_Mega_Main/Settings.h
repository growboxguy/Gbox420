...
///SAVED TO EEPROM - Settings struct
  ...
  typedef struct
  {
    ...
    struct LightsSettings Lt1 = {.RelayPin = 29, .DimmingPin = 11, .DimmingLimit = 14}; ///Creating a LightSettings instance, passing in the unique parameters
    struct LightsSettings Lt2 = {.RelayPin = 24, .DimmingPin = 12, .DimmingLimit = 6}; ///Creating a LightSettings instance, passing in the unique parameters
