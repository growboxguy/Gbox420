...
const char* MqttAeroMinPressure = "AeroMinPressure";
const char* MqttAeroMaxPressure = "AeroMaxPressure";
...
void mqttReceived(void* response) {
  ...
  else if(strstr(topic,MqttAeroMinPressure)!=NULL) {setAeroMinPressure(atof(data));}
  else if(strstr(topic,MqttAeroMaxPressure)!=NULL) {setAeroMaxPressure(atof(data));} 
