...
const char* MqttAeroLowPressure = "AeroLowPressure";
const char* MqttAeroHighPressure = "AeroHighPressure";
...
void mqttReceived(void* response) {
  ...
  else if(strstr(topic,MqttAeroLowPressure)!=NULL) {setAeroLowPressure(atof(data));}
  else if(strstr(topic,MqttAeroHighPressure)!=NULL) {setAeroHighPressure(atof(data));} 
  ...
  else if(strstr(topic,MqttDebugEnabled)!=NULL) {setDebug(atoi(data));}
