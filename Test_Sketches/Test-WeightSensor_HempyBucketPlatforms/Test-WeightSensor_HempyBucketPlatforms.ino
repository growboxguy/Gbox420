...
const float WeightSensor1_CalibrationWeight = 7.0; //SET THIS TO the reference weight units (kg or lbs) that will be used during the calibration
const float WeightSensor2_CalibrationWeight = 7.0; //SET THIS TO the reference weight units (kg or lbs) that will be used during the calibration
