    ...
    for (var j = 0; j < Properties.length; j++) {
      ...
      if(match != -1)
      {
        try{          
          ...
          if(Debug)LogToConsole(key + " log column matched: " + match + ". Updating to: " + valueToWriteBack,true,3);
        }
        catch(e){
        ...
        try{
          ...
          if(Debug)LogToConsole(key + " log column not found, adding it with value: " + valueToWriteBack,true,3); 
        }
        catch(e){
          LogToConsole(e,true,1);
        }
