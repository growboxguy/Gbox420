...
typedef struct
{
  ...
  char MqttPubTopic[MaxShortTextLength] = {"Gbox420/Hempy/"};       ///< Publish MQTT messages to this topic. Ends with a forward slash
  char MqttSubTopic[MaxShortTextLength] = {"Gbox420CMD/Hempy/#"};   ///< Subscribe to messages of this topic and all sub-topic
  char MqttLwtTopic[MaxShortTextLength] = {"Gbox420LWT/Hempy/"};    ///< When the connection is lost the MQTT broker will publish a final message to this topic. Ends with a forward slash
