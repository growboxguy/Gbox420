...
typedef struct
{
  ...
  struct ReservoirModuleSettings Res1 = {.SerialReportFrequency = 15, .SerialReportDate = true, .SerialReportMemory = true, .SerialReportText = true, .SerialReportJSON = true, .SerialReportWireless = true};
