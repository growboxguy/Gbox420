...
protected:
  ...
  RollingAverage WasteReservoirWeight;      ///< Average waste reservoir weight based on the last few readings, RollingAverageDepth in Settings.h defines how many readings to calculate from
