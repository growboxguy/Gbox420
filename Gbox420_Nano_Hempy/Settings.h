...
typedef struct
{
  ...
  struct HempyModuleSettings
  {
    ...
    bool SerialReportJSON; ///< Enable/disable sending JSON formatted reports to the Serial outpu
  };
  struct HempyModuleSettings Hemp1 = {.SerialReportFrequency = 15, .SerialReportDate = true, .SerialReportMemory = true, .SerialReportText = true, .SerialReportJSON = true};
