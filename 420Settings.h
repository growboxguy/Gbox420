...
{  
 ...
 struct DHTSensorSettings{ //initialized via Designated initializer https://riptutorial.com/c/example/18609/using-designated-initializers
  ...
  struct AeroponicsSettings{ //Common settings for both inheriting classes: Aeroponics_Tank and Aeroponics_NoTank
  ...
  struct AeroponicsSettings_TankSpecific{  //Settings for an Aeroponics setup WITH a pressure tank
  ...
  struct ModuleSkeletonSettings{  //Test module
