...
class LightSensor : public Common
{
  public:
    ...
    char * getReadingText(bool IncludePercentage); //returns the current light sensor reading. If IncludeMinMax is set to true it also includes the calibated minimum and maximum readings
