/*
  uart_drv.h - Library for Arduino Wifi shield.
...
*/
    ...
    static uint8_t readParamLen8(uint8_t* param_len = 0x0);

    static uint16_t readParamLen16(uint16_t* param_len = 0x0);
