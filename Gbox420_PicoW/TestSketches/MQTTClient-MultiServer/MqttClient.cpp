...
MqttClient::MqttClient(MQTTClientSettings *DefaultSettings, void *DataCallback)
{
...
void MqttClient::mqttSubscribe_Unsubscribe(const char *SubTopic, u8_t QoS, bool Subscribe)
{
    if (Subscribe)
    {
...
void MqttClient::mqttIncomingTopic_Callback(void *Arg, const char *Topic, u32_t Tot_len)
{
    printf("Incoming topic: %s ,total length: %u\n", Topic, (unsigned int)Tot_len);
}

void MqttClient::mqttIncomingData_Callback(void *Arg, const u8_t *Data, u16_t Len, u8_t Flags)
{
...
void MqttClient::mqttPublish(const char *PubTopic, const char *PubData, u8_t QoS, bool Retain)
{
