...
char ShortMessage[MaxShortTextLength] = "";                    ///< Temp storage for assembling short messages (Log entries, Error messages) //TODO: Use Message buffers instead
bool &Debug = *new bool;                                                     ///< True - Turns on extra debug messages on the Serial Output
__attribute__((noinit)) char DebugMessage[MaxShortTextLength]; ///< Not zero initialized, keeps value from last watchdog reset
