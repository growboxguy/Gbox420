...
ModuleSkeleton::ModuleSkeleton(const __FlashStringHelper *Name, GrowBox *GBox, Settings::ModuleSkeletonSettings *DefaultSettings) : Common_Web(Name)
{ //constructor
  this->GBox = GBox;
...
void ModuleSkeleton::websiteEvent_Button(char *Button)
...
void ModuleSkeleton::websiteEvent_Field(char *Field)
