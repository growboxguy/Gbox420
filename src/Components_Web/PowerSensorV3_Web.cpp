...
PowerSensorV3_Web::PowerSensorV3_Web(const __FlashStringHelper *Name, Module_Web *Parent, HardwareSerial *SerialPort) : PowerSensorV3(Name,Parent,SerialPort), Common(Name), Common_Web(Name)
{
  this->Parent = Parent;
  this->Name = Name;
